...
#region Message Sending
        ...
        protected virtual void OnTimedOutWaitingForResponse(AbstractCoAPMessage coapMsg)
        {
            ...
            {
                coapMsg.Timeout = (int)(Math.Pow((double)AbstractCoAPChannel.DEFAULT_ACK_TIMEOUT_SECS,(double)(coapMsg.RetransmissionCount + 1)) * AbstractCoAPChannel.DEFAULT_ACK_RANDOM_FACTOR);
                //attempt resend
                this.Send(coapMsg);
            }
        }
